...
urlpatterns = [
    ...
    path('api/lessons/<int:pk>/', views.LessonDetailView.as_view(), name='api-lesson-detail'),
    path('api/exercises/<int:pk>/submit/', views.SubmitExerciseView.as_view(), name='api-submit-exercise'),
    path('api/lessons/<int:pk>/complete/', views.CompleteLessonView.as_view(), name='api-complete-lesson'),
]
