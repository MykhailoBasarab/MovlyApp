...
urlpatterns = [
    ...
    path(
        "attempt/<int:attempt_id>/question/<int:question_id>/submit/",
        views.submit_test_answer_view,
    ...
    path(
        "attempts/<int:pk>/",
        views.TestAttemptDetailView.as_view(),
        name="api-attempt-detail",
    ),
    path(
        "attempts/<int:pk>/sections/<int:section_id>/",
        views.SectionQuestionsView.as_view(),
        name="api-section-questions",
    ),
    path(
    ...
    path(
        ...
        views.CompleteTestView.as_view(),
        name="api-complete-test",
    ),
]
